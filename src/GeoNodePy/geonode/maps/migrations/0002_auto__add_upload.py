...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Upload'
        db.create_table('maps_upload', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('import_id', self.gf('django.db.models.fields.BigIntegerField')()),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
            ('state', self.gf('django.db.models.fields.CharField')(max_length=16)),
            ('date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
        ))
        db.send_create_signal('maps', ['Upload'])


    def backwards(self, orm):
        
        # Deleting model 'Upload'
        db.delete_table('maps_upload')
    ...
    models = {
        ...
        'maps.upload': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'import_id': ('django.db.models.fields.BigIntegerField', [], {}),
